#!/usr/bin/env python3
# GROW v4.0 - Loads advisory Plant Buddy profiles from JSON persistence.

import json
from datetime import datetime, timezone

REGISTRY_PATH = "/config/packages/grow/grow_registry.json"
PROFILES_PATH = "/config/packages/grow/grow_plant_profiles.json"
